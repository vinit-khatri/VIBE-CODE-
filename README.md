...
[![CLICK HERE TO VIEW -EZshopy](https://img.shields.io/badge/Style-EZ%20Shopy-0ea5e9)](https://shopy-animate.preview.emergentagent.com/?utm_source=share)
...
[![Built with Emergent AI](https://img.shields.io/badge/Built%20with-Emergent%20AI-8b5cf6)](https://emergent.sh)
[![Style-Vibe Coding](https://img.shields.io/badge/Style-Vibe%20Coding-0ea5e9)](#-what-is-vibe-coding)
...
```mermaid
flowchart LR
  A[Describe the goal] --> B[AI generates]
  B --> C[Run & review]
  C --> D[Refine prompt]
  D --> A
```
